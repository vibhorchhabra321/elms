  ...
  <div class="row content">
    <div class="col-sm-3 sidenav hidden-xs">
      ...
      <ul class="nav nav-pills nav-stacked">
        ...
        <li><a href="./admin/admin_courses.jsp">Manage Courses</a></li>
        <li><a href="./admin/admin_students.jsp">Manage Students</a></li>
        <li><a href="./admin/admin_instructors.jsp">Manage Instructors</a></li>
        <li><a href="./admin/admin_complaints.jsp">Manage Complaints & Feedbacks</a></li>
      </ul><br>
    </div>
    <br>
