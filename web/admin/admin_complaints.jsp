  ...
  <div class="row content">
    <div class="col-sm-3 sidenav hidden-xs">
      ...
      <ul class="nav nav-pills nav-stacked">
        ...
        <li><a href="admin_course_type.jsp">Manage Course Category</a></li>
        <li><a href="#section3">Manage Courses</a></li>
        <li><a href="#section3">Manage Students</a></li>
        <li><a href="#section3">Manage Instructors</a></li>
        <li><a href="#section3">Manage Complaints & Feedbacks</a></li>
      </ul><br>
    </div>
    <br>
